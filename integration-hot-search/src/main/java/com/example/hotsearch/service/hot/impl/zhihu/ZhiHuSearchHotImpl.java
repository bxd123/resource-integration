package com.example.hotsearch.service.hot.impl.zhihu;
...
@Service
@Slf4j
public class ZhiHuSearchHotImpl extends HttpClient implements HotSearchService {

    public ZhiHuSearchHotImpl(@Autowired Map<String, String> baseUrlMap) {
    ...
    @Override
    public R searchHot() {
        final WebTarget webTarget = this.webTarget.path("v2/zhihuhot");
        try {
