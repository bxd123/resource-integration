package com.example.hotsearch.service.hot.impl.weibo;
...
@Service
@Slf4j
public class WeiBoSearchHotImpl extends HttpClient implements HotSearchService {

    public WeiBoSearchHotImpl(@Autowired Map<String, String> baseUrlMap) {
    ...
    @Override
    public R searchHot() {
        final WebTarget webTarget = this.webTarget.path("v2/weibohot");
        try {
