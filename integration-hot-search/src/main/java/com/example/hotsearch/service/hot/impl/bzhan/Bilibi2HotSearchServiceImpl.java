...
@Slf4j
@Service
public class Bilibi2HotSearchServiceImpl extends HttpClient implements HotSearchService {

    public Bilibi2HotSearchServiceImpl(@Autowired Map<String, String> baseUrlMap) {
    ...
    @Override
    public R searchHot() {
        final WebTarget webTarget = this.webTarget.path("v2/bilihot");
        try {
