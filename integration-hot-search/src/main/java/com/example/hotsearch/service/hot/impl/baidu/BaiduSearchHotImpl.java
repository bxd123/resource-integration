package com.example.hotsearch.service.hot.impl.baidu;
...
@Service
@Slf4j
public class BaiduSearchHotImpl extends HttpClient implements HotSearchService {

    public BaiduSearchHotImpl(@Autowired Map<String, String> baseUrlMap) {
    ...
    @Override
    public R searchHot() {
        final WebTarget webTarget = this.webTarget.path("v2/baiduhot");
        try {
